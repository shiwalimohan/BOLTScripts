...
$demo_number=@objects-1;
$demoObject2="table";
$demoObject1=$objects[$demo_number];
print "# The demo object is " . $demoObject1 . "\n";
print "# Training the agent for the demo object \n";
print "} Put the " . $demoObject1 . " on the board\n";
print "> Point to the ". $demoObject1 . "\n";
print $teachObjects[$demo_number];
print "} Reset arm\n";
...
for($j=0;$j<$trialLength;$j++){
	...
	$objectIndex = int(rand($objectSelectionLength-1));
	...
	if ($currentVerb eq $store){
            print "} Place" . " the " . $verbDirectObject . "anywhere other than in the pantry\n"; 
	...
	if ($currentVerb eq $discard){
            print "} Place" . " the " . $verbDirectObject . "anywhere other than in the garbage\n"; 
